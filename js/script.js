...
//  теория(Метод map() и массив объектов)
// const students = [
//   { name: 'Манго', score: 83 },
//   { name: 'Поли', score: 59 },
//   { name: 'Аякс', score: 37 },
...
//  return  usersName = users.map((user) => user.name);
...
//     return usersEmail =users.map((user) => user.email);
...
//  16 
//  теория (Фильтрация уникальных элементов)
// const students = [
//   { name: 'Манго', courses: ['математика', 'физика'] },
//   { name: 'Поли', courses: ['информатика', 'математика'] },
//   { name: 'Киви', courses: ['физика', 'биология'] }
...
//  теория (Метод filter() и массив объектов)
// const LOW_SCORE = 50;
// const HIGH_SCORE = 80;
// const students = [
//   { name: 'Манго', score: 83 },
...
//   return uniqueFriends = allFriends.filter((friend, index, array) => array.indexOf(friend) === index);
// };
// // Пиши код выше этой строки
// console.log(uniqueFriends(users));
...
// console.log(getUserWithEmail(users, 'mango4@mail.com'));
...
//  задача (проверка массивов на четность/нечетность)
...
//    return [...users].sort((firstAmountOfFriends, secondAmountOfFriends) => secondAmountOfFriends.friends.length - firstAmountOfFriends.friends.length)
// };
// // Пиши код выше этой строки
...
//  41
//  теория (Цепочки методов (чейнинг, chaining))
...
//    return [...users].sort((firstAmountOfFriends, secondAmountOfFriends) => 
//  firstAmountOfFriends.friends.length - secondAmountOfFriends.friends.length).map(user => user.name)
// };
// // Пиши код выше этой строки
